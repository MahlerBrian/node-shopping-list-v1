...
//binding recipies to the same model
...
Recipes.create('chocolate milk', ['cocoa', 'sugar', 'milk']);
Recipes.create('falafel', ['chick-peas', 'eggs', 'zaatar']);
...
//creating get endpoint for recipes
